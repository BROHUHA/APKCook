...
namespace APKCook.Core.Services.Patching;
...
public sealed class SmaliPatchService : ISmaliPatchService
{
    ...
    private static string RewriteRootCheckPathLiterals(string line)
    {
        ...
        return RootPathLiteralRegex.Replace(line, match =>
        {
            ...
            var fakePath = $"/dev/apkcook-fake-root-{replacementIndex++}";
    ...
    private static IReadOnlyList<string> BuildSampleInjectionHelperMethods()
    {
        ...
        [
            ...
            "    .locals 2",
            string.Empty,
            "    const-string v0, \"APKCook\"",
            "    const-string v1, \"APKCook: The app sample patch was applied\"",
            "    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I",
            "    move-result v0",
            "    return-void",
            ".end method",
    ...
    {
        var manifestPath = Path.Combine(decompiledDirectory, "AndroidManifest.xml");
        var packageName = ReadPackageName(decompiledDirectory) ?? "com.apkcook.generated";
