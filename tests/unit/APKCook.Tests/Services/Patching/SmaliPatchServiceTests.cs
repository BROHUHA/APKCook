...
.end class");
        ...
        Assert.Contains("APKCook: The app sample patch was applied", output, StringComparison.Ordinal);
...
.end class");
        ...
        Assert.Contains("/dev/apkcook-fake-root-0", output, StringComparison.Ordinal);
