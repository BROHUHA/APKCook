using System;
using System.IO;
using APKCook.Core.Utils;
using Xunit;

namespace APKCook.Tests.Utils
{
    public class PathUtilsTests
    {
        ...
        public void GetDefaultReportsPath_ShouldEndWithReportsDirectory()
        {
            ...
            Assert.EndsWith($"APKCook{Path.DirectorySeparatorChar}reports", path, StringComparison.OrdinalIgnoreCase);
        }
