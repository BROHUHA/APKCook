...
$avaloniaCsprojPath = Join-Path $repoRoot "src/APKCook.Avalonia/APKCook.Avalonia.csproj"
$coreCsprojPath = Join-Path $repoRoot "src/APKCook.Core/APKCook.Core.csproj"
$aboutPath = Join-Path $repoRoot "src/APKCook.Core/ViewModels/AboutViewModel.cs"
